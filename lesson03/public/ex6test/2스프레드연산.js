...
const kor = [90,80,77]
const eng = [77,88,100]
//배열의 스프레드 연산 :두개의 배열을 합쳐서 새로운 배열 만들떄
const scores = [...kor,...eng] 
console.log('배열 합치기 scores :' , scores)

//객체에 스프레드연산:  기존 객체 복사하여 새로운 객체 생성
//                    ㄴ새로운 속성값 추가 or 기존 속성값 수정 
...
//people 에 새로운 속성 추가 하기
people.email = 'loreait@gmail.com'
//people 에 기존 속성 값 변경하기
people['name'] = '아이브  ' //people.name = '아이브' 와 동일 
console.log('새로운 객체 people' , people)